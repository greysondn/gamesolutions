...
function startLevel(map) {
    ...
    map.getPlayer().setPhoneCallback(function () {
        ...
        // obtain handle to player
        var player = map.getPlayer();
        
        // get player's color
        var colour = player.getColor();
        
        // switch on player's color to rotate through useful ones
        switch (colour)
        {
           case "#0f0":
           case "#0F0":
        ...
        // click the phone as you progress to the right
        // to cycle your colors. Quod erat demonstratum.
